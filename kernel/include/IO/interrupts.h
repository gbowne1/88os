#indef OS_IO_INTERRUPTS_H
#define OS_IO_INTERRUPTS_H
    ...
    namespace IO
    {
        ...
        class InterruptManager
        {
            ...
            struct GateDescriptor
            {
                ...
                common::uint16_t handlerAccessHighBits;
            }__attribute__((packed));

            static struct GateDescriptor InterrupDescriptorTable[256];
        ...
        public:
            ...
            static common::uint32_t HandleInterrupt(common::uint8_t interruptNumber, common::uint8_t esp);
            common::uint32_t DoHandleInterrupt(common::uint8_t interruptNumber, common::uint8_t esp);
